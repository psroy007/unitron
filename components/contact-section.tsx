          ...
          <motion.div className="p-8 bg-spider-dark-blue/20 rounded-lg comic-panel" variants={itemVariants}>
            ...
            <div className="grid gap-8 md:grid-cols-3">
              <div className="flex flex-col items-center text-center">
                <div className="flex items-center justify-center w-16 h-16 mb-4 bg-spider-red rounded-full">
                  <MapPin className="w-8 h-8 text-white" />
                </div>
                <h4 className="text-lg font-bangers text-spider-blue">Location</h4>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h4 className="text-lg font-medium text-spider-blue font-bangers">Email</h4>
                <p className="mt-2 text-gray-300 font-comic">
                unitron.fit@gmail.com
                </p>
              </div>
