  ...
  const events = [
    {
      ...
      rules: [
        ...
        "A team can have a minimum of two and a maximum of four members.",
        ...
        "The bot should be totally wireless and manually designed.",
        "For a wirelessly controlled robot there should be 4 channels for controlling the robot.",
        "Damage to the arena may lead to disqualification of the bot.",
      ],
      coordinators: [
