  ...
  const events = [
    {
      ...
      coordinators: [
        { name: "Jessica Drew", contact: "+91 98765 43216" },
        { name: "Ben Reilly", contact: "+91 98765 43217" },
      ],
      gallery: [
    ...
    },
    {
      ...
      coordinators: [
        { name: "Otto Octavius", contact: "+91 98765 43218" },
        { name: "Max Dillon", contact: "+91 98765 43219" },
      ],
      gallery: [
        "/placeholder.svg?height=400&width=600",
        "/placeholder.svg?height=400&width=600",
